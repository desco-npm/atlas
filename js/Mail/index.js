...
var Mail = /** @class */ (function () {
    ...
    Mail.prototype.transporter = function (name) {
        if (name === void 0) { name = 'default'; }
        return this.transporters[name] || null;
    };
    /** Prepares the Mail */
    Mail.prototype.prepare = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                mails.map(function (m) {
                    ...
                    var name = m.name || "Mail" + (Object.keys(_this.transporters).length + 1);
                    // Create and store the conveyor
                    _this.transporters[name] = NodeMailer_1.default.createTransport(m);
                });
                return [2 /*return*/];
            });
        });
